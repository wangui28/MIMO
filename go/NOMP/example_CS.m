...
p_fa = 1e-2;
tau = sigma_white^2 * ( log(N) - log( log(1/(1-p_fa)) ) );

[omega_est, gain_est, residue] = extractSpectrum(y_white, S_white, tau);
...
figure; stem(0:(length(residue)-1), 10*log10(residue/sigma_white^2/M));
