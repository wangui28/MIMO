...
if type==1 && snr_range==1
    load(['Trained_GM_LAMP_for_SV_ULA_',num2str(N),num2str(M),'0to10dB.mat'])
end
if type==1 && snr_range==2
    load(['Trained_GM_LAMP_for_SV_ULA_',num2str(N),num2str(M),'10to20dB.mat'])
end
if type==2 && snr_range==1
    load(['Trained_GM_LAMP_for_SV_UPA_',num2str(N),num2str(M),'0to10dB.mat'])
end
if type==2 && snr_range==2
    load(['Trained_GM_LAMP_for_SV_UPA_',num2str(N),num2str(M),'10to20dB.mat'])
end
